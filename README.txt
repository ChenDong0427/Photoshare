To get the this app running, open a terminal and do the following:
	...
	5. open app.py using your favorite editor, change the 'RandomCharacters' in 'app.config['MYSQL_DATABASE_PASSWORD'] = 'RandomCharacters'' to your MySQL root password. You need to keep the quotations around your root password
